...
const CATALOG = {
  ...
  'TB10':   { name: 'TB-500 10mg', cost: 280, elite: 3799, line: 'wolverine', initial: 10 },
  'BB20':   { name: 'Wolverine BB20', cost: 340, elite: 5499, line: 'wolverine', initial: 10 },
  'GLOW70': { name: 'Trinity GLOW 70mg', cost: 400, elite: 7499, line: 'glow', initial: 10 },
  'CU100':  { name: 'GHK-Cu 100mg', cost: 100, elite: 3799, line: 'glow', initial: 20 },
  'KPV10':  { name: 'KPV 10mg', cost: 120, elite: 2899, line: 'wolverine', initial: 10 },
  'IP10':   { name: 'Ipamorelin 10mg', cost: 140, elite: 2899, line: 'prime', initial: 10 },
  'TSM10':  { name: 'Tesamorelin 10mg', cost: 360, elite: 7499, line: 'prime', initial: 20 },
  'NJ1000': { name: 'NAD+ 1000mg', cost: 252, elite: 5499, line: 'highlander', initial: 10 },
  'ET50':   { name: 'Epithalon 50mg', cost: 280, elite: 6799, line: 'highlander', initial: 10 },
  'SX10':   { name: 'Semax 10mg', cost: 140, elite: 2899, line: 'prime', initial: 10 },
...
const STRIPE_LINK_TO_ITEMS = {
  ...
  'dRmcN62sDfwk3PH2lads403': { name: 'GLOW Essential', items: [{ sku: 'GLOW70', qty: 1 }, { sku: 'BA3', qty: 1 }], amount: 7499 },
